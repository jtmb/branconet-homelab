...
const navItems = [
  { href: "/vars", label: "Variables", icon: Database },
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-zinc-100">Branconet K8s Manager</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <Link href="/vars" className="glass-card p-6 rounded-xl hover:bg-zinc-800/80 transition-colors group">
            <Database className="w-12 h-12 text-indigo-400 mb-4 group-hover:scale-110 transition-transform" />
            <h3 className="text-lg font-semibold text-zinc-100 mb-2">Configure Variables</h3>
            <p className="text-zinc-400 text-sm">Set up Ansible variables for your cluster configuration</p>
          </Link>
          ...
          <Link href="/cluster" className="glass-card p-6 rounded-xl hover:bg-zinc-800/80 transition-colors group">
      ...
      <footer className="border-t border-zinc-800 mt-12 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-zinc-500 text-sm">
          <p>Branconet Homelab • Kubernetes Cluster Manager</p>
        </div>
      </footer>
    </div>
  );
