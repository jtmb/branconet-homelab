# kubectl Cheat Sheet — Branconet Homelab (Rancher K8s)
...
kubectl get all -n discord-bots
...
alias kdb='kubectl -n discord-bots'
alias khome='kubectl -n homepage'
alias kmedia='kubectl -n media-stack'
```
